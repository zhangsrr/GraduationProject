...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "pyknotid.cinvariants",
        "sources": [
            "pyknotid/cinvariants.pyx"
        ]
    },
    "module_name": "pyknotid.cinvariants"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pyknotid__cinvariants
#define __PYX_HAVE_API__pyknotid__cinvariants
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'pyknotid.cinvariants' */
...
static long __pyx_f_8pyknotid_11cinvariants_crude_modulus(long, long); /*proto*/
static PyObject *__pyx_f_8pyknotid_11cinvariants_vassiliev_degree_3(__Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "pyknotid.cinvariants"
extern int __pyx_module_is_main_pyknotid__cinvariants;
int __pyx_module_is_main_pyknotid__cinvariants = 0;

/* Implementation of 'pyknotid.cinvariants' */
...
static const char __pyx_k_vprint[] = "vprint";
...
static const char __pyx_k_pyknotid_utils[] = "pyknotid.utils";
...
static PyObject *__pyx_n_s_pyknotid_utils;
...
static PyObject *__pyx_pf_8pyknotid_11cinvariants_vassiliev_degree_3(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arrows); /* proto */
...
static long __pyx_f_8pyknotid_11cinvariants_crude_modulus(long __pyx_v_val, long __pyx_v_modulo) {
  long __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("crude_modulus", 0);

  /* "pyknotid/cinvariants.pyx":9
 * 
 * cdef long crude_modulus(long val, long modulo):
 *     if val < 0:             # <<<<<<<<<<<<<<
 *         return val + modulo
 ...
 * 
 */
    __pyx_r = (__pyx_v_val + __pyx_v_modulo);
    goto __pyx_L0;
...
static PyObject *__pyx_pw_8pyknotid_11cinvariants_1vassiliev_degree_3(PyObject *__pyx_self, PyObject *__pyx_arg_arrows); /*proto*/
static PyObject *__pyx_f_8pyknotid_11cinvariants_vassiliev_degree_3(__Pyx_memviewslice __pyx_v_arrows, CYTHON_UNUSED int __pyx_skip_dispatch) {
  long __pyx_v_num_arrows;
  long __pyx_v_num_crossings;
  long __pyx_v_a1s;
  long __pyx_v_a1e;
  long __pyx_v_a2s;
  long __pyx_v_a2e;
  long __pyx_v_a3s;
  long __pyx_v_a3e;
  __Pyx_memviewslice __pyx_v_arrow1 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_arrow2 = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_arrow3 = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_i1;
  long __pyx_v_i2;
  long __pyx_v_i3;
  long __pyx_v_sign1;
  long __pyx_v_sign2;
  long __pyx_v_sign3;
  PyObject *__pyx_v_used_sets = 0;
  long __pyx_v_representations_sum_1;
  long __pyx_v_representations_sum_2;
  PyObject *__pyx_v_ordered_indices = 0;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("vassiliev_degree_3", 0);

  /* "pyknotid/cinvariants.pyx":17
 * @cython.boundscheck(False)
 * cpdef vassiliev_degree_3(long [:, :] arrows):
 *     cdef long num_arrows = len(arrows)             # <<<<<<<<<<<<<<
 *     cdef long num_crossings = len(arrows) * 2
 * 
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_arrows); 
  __pyx_v_num_arrows = __pyx_t_1;

  /* "pyknotid/cinvariants.pyx":18
 * cpdef vassiliev_degree_3(long [:, :] arrows):
 *     cdef long num_arrows = len(arrows)
 *     cdef long num_crossings = len(arrows) * 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_arrows); 
  __pyx_v_num_crossings = (__pyx_t_1 * 2);

  /* "pyknotid/cinvariants.pyx":25
 ...
 */
  ...
  __pyx_v_used_sets = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "pyknotid/cinvariants.pyx":26
 * 
 *     cdef set used_sets = set()
 *     cdef long representations_sum_1 = 0             # <<<<<<<<<<<<<<
 *     cdef long representations_sum_2 = 0
 ...
 */
  __pyx_v_representations_sum_1 = 0;

  /* "pyknotid/cinvariants.pyx":27
 *     cdef set used_sets = set()
 *     cdef long representations_sum_1 = 0
 *     cdef long representations_sum_2 = 0             # <<<<<<<<<<<<<<
 *     cdef tuple ordered_indices
 ...
 */
  __pyx_v_representations_sum_2 = 0;

  /* "pyknotid/cinvariants.pyx":29
 *     cdef long representations_sum_2 = 0
 *     cdef tuple ordered_indices
 *     for i1 in range(num_arrows):             # <<<<<<<<<<<<<<
 *         arrow1 = arrows[i1]
 *         a1s = arrow1[0]
 */
  __pyx_t_3 = __pyx_v_num_arrows;
  __pyx_t_4 = __pyx_t_3;
  for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
    __pyx_v_i1 = __pyx_t_5;

    /* "pyknotid/cinvariants.pyx":30
 *     cdef tuple ordered_indices
 *     for i1 in range(num_arrows):
 *         arrow1 = arrows[i1]             # <<<<<<<<<<<<<<
 *         a1s = arrow1[0]
 *         a1e = arrow1[1]
 */
    __pyx_t_6.data = __pyx_v_arrows.data;
    __pyx_t_6.memview = __pyx_v_arrows.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_6, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_i1;
    Py_ssize_t __pyx_tmp_stride = __pyx_v_arrows.strides[0];
        __pyx_t_6.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_6.shape[0] = __pyx_v_arrows.shape[1];
__pyx_t_6.strides[0] = __pyx_v_arrows.strides[1];
    __pyx_t_6.suboffsets[0] = -1;

__PYX_XDEC_MEMVIEW(&__pyx_v_arrow1, 1);
    __pyx_v_arrow1 = __pyx_t_6;
    __pyx_t_6.memview = NULL;
    __pyx_t_6.data = NULL;

    /* "pyknotid/cinvariants.pyx":31
 *     for i1 in range(num_arrows):
 *         arrow1 = arrows[i1]
 *         a1s = arrow1[0]             # <<<<<<<<<<<<<<
 *         a1e = arrow1[1]
 ...
 */
    __pyx_t_7 = 0;
    __pyx_v_a1s = (*((long *) ( /* dim=0 */ (__pyx_v_arrow1.data + __pyx_t_7 * __pyx_v_arrow1.strides[0]) )));

    /* "pyknotid/cinvariants.pyx":32
 *         arrow1 = arrows[i1]
 *         a1s = arrow1[0]
 *         a1e = arrow1[1]             # <<<<<<<<<<<<<<
 *         sign1 = arrow1[2]
 ...
 */
    __pyx_t_7 = 1;
    __pyx_v_a1e = (*((long *) ( /* dim=0 */ (__pyx_v_arrow1.data + __pyx_t_7 * __pyx_v_arrow1.strides[0]) )));

    /* "pyknotid/cinvariants.pyx":33
 *         a1s = arrow1[0]
 *         a1e = arrow1[1]
 *         sign1 = arrow1[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_7 = 2;
    __pyx_v_sign1 = (*((long *) ( /* dim=0 */ (__pyx_v_arrow1.data + __pyx_t_7 * __pyx_v_arrow1.strides[0]) )));

    /* "pyknotid/cinvariants.pyx":35
 *         sign1 = arrow1[2]
 * 
 *         a1e = crude_modulus(a1e - a1s, num_crossings)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_a1e = __pyx_f_8pyknotid_11cinvariants_crude_modulus((__pyx_v_a1e - __pyx_v_a1s), __pyx_v_num_crossings);

    /* "pyknotid/cinvariants.pyx":37
 *         a1e = crude_modulus(a1e - a1s, num_crossings)
 * 
 *         for i2 in range(num_arrows):             # <<<<<<<<<<<<<<
 *             arrow2 = arrows[i2]
 *             a2s = arrow2[0]
 */
    __pyx_t_8 = __pyx_v_num_arrows;
    __pyx_t_9 = __pyx_t_8;
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      __pyx_v_i2 = __pyx_t_10;

      /* "pyknotid/cinvariants.pyx":38
 * 
 *         for i2 in range(num_arrows):
 *             arrow2 = arrows[i2]             # <<<<<<<<<<<<<<
 *             a2s = arrow2[0]
...
__PYX_XDEC_MEMVIEW(&__pyx_v_arrow2, 1);
      __pyx_v_arrow2 = __pyx_t_6;
      __pyx_t_6.memview = NULL;
      __pyx_t_6.data = NULL;

      /* "pyknotid/cinvariants.pyx":39
 *         for i2 in range(num_arrows):
 *             arrow2 = arrows[i2]
 *             a2s = arrow2[0]             # <<<<<<<<<<<<<<
 *             a2e = arrow2[1]
 ...
 */
      __pyx_t_7 = 0;
      __pyx_v_a2s = (*((long *) ( /* dim=0 */ (__pyx_v_arrow2.data + __pyx_t_7 * __pyx_v_arrow2.strides[0]) )));

      /* "pyknotid/cinvariants.pyx":40
 *             arrow2 = arrows[i2]
 *             a2s = arrow2[0]
 *             a2e = arrow2[1]             # <<<<<<<<<<<<<<
 *             sign2 = arrow2[2]
 ...
 */
      __pyx_t_7 = 1;
      __pyx_v_a2e = (*((long *) ( /* dim=0 */ (__pyx_v_arrow2.data + __pyx_t_7 * __pyx_v_arrow2.strides[0]) )));

      /* "pyknotid/cinvariants.pyx":41
 *             a2s = arrow2[0]
 *             a2e = arrow2[1]
 *             sign2 = arrow2[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = 2;
      __pyx_v_sign2 = (*((long *) ( /* dim=0 */ (__pyx_v_arrow2.data + __pyx_t_7 * __pyx_v_arrow2.strides[0]) )));

      /* "pyknotid/cinvariants.pyx":43
 *             sign2 = arrow2[2]
 * 
 *             a2s = crude_modulus(a2s - a1s, num_crossings)             # <<<<<<<<<<<<<<
 ...
 * 
 */
      __pyx_v_a2s = __pyx_f_8pyknotid_11cinvariants_crude_modulus((__pyx_v_a2s - __pyx_v_a1s), __pyx_v_num_crossings);

      /* "pyknotid/cinvariants.pyx":44
 * 
 *             a2s = crude_modulus(a2s - a1s, num_crossings)
 *             a2e = crude_modulus(a2e - a1s, num_crossings)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_v_a2e = __pyx_f_8pyknotid_11cinvariants_crude_modulus((__pyx_v_a2e - __pyx_v_a1s), __pyx_v_num_crossings);

      /* "pyknotid/cinvariants.pyx":46
 *             a2e = crude_modulus(a2e - a1s, num_crossings)
 * 
 *             for i3 in range(num_arrows):             # <<<<<<<<<<<<<<
 *                 arrow3 = arrows[i3]
 *                 a3s = arrow3[0]
 */
      __pyx_t_11 = __pyx_v_num_arrows;
      __pyx_t_12 = __pyx_t_11;
      for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
        __pyx_v_i3 = __pyx_t_13;

        /* "pyknotid/cinvariants.pyx":47
 * 
 *             for i3 in range(num_arrows):
 *                 arrow3 = arrows[i3]             # <<<<<<<<<<<<<<
 *                 a3s = arrow3[0]
...
__PYX_XDEC_MEMVIEW(&__pyx_v_arrow3, 1);
        __pyx_v_arrow3 = __pyx_t_6;
        __pyx_t_6.memview = NULL;
        __pyx_t_6.data = NULL;

        /* "pyknotid/cinvariants.pyx":48
 *             for i3 in range(num_arrows):
 *                 arrow3 = arrows[i3]
 *                 a3s = arrow3[0]             # <<<<<<<<<<<<<<
 *                 a3e = arrow3[1]
 ...
 */
        __pyx_t_7 = 0;
        __pyx_v_a3s = (*((long *) ( /* dim=0 */ (__pyx_v_arrow3.data + __pyx_t_7 * __pyx_v_arrow3.strides[0]) )));

        /* "pyknotid/cinvariants.pyx":49
 *                 arrow3 = arrows[i3]
 *                 a3s = arrow3[0]
 *                 a3e = arrow3[1]             # <<<<<<<<<<<<<<
 *                 sign3 = arrow3[2]
 ...
 */
        __pyx_t_7 = 1;
        __pyx_v_a3e = (*((long *) ( /* dim=0 */ (__pyx_v_arrow3.data + __pyx_t_7 * __pyx_v_arrow3.strides[0]) )));

        /* "pyknotid/cinvariants.pyx":50
 *                 a3s = arrow3[0]
 *                 a3e = arrow3[1]
 *                 sign3 = arrow3[2]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_7 = 2;
        __pyx_v_sign3 = (*((long *) ( /* dim=0 */ (__pyx_v_arrow3.data + __pyx_t_7 * __pyx_v_arrow3.strides[0]) )));

        /* "pyknotid/cinvariants.pyx":52
 *                 sign3 = arrow3[2]
 * 
 *                 a3s = crude_modulus(a3s - a1s, num_crossings)             # <<<<<<<<<<<<<<
 ...
 * 
 */
        __pyx_v_a3s = __pyx_f_8pyknotid_11cinvariants_crude_modulus((__pyx_v_a3s - __pyx_v_a1s), __pyx_v_num_crossings);

        /* "pyknotid/cinvariants.pyx":53
 * 
 *                 a3s = crude_modulus(a3s - a1s, num_crossings)
 *                 a3e = crude_modulus(a3e - a1s, num_crossings)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_v_a3e = __pyx_f_8pyknotid_11cinvariants_crude_modulus((__pyx_v_a3e - __pyx_v_a1s), __pyx_v_num_crossings);

        /* "pyknotid/cinvariants.pyx":55
 *                 a3e = crude_modulus(a3e - a1s, num_crossings)
 * 
 *                 ordered_indices = tuple(sorted((i1, i2, i3)))             # <<<<<<<<<<<<<<
 ...
 *                     continue
 */
        __pyx_t_14 = __Pyx_PyInt_From_long(__pyx_v_i1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_14);
        __pyx_t_15 = __Pyx_PyInt_From_long(__pyx_v_i2); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_15);
        __pyx_t_16 = __Pyx_PyInt_From_long(__pyx_v_i3); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_16);
        __pyx_t_17 = PyList_New(3); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 55, __pyx_L1_error)
        ...
        __pyx_t_17 = 0;
        __pyx_t_18 = PyList_Sort(__pyx_t_2); if (unlikely(__pyx_t_18 == ((int)-1))) __PYX_ERR(0, 55, __pyx_L1_error)
        if (unlikely(__pyx_t_2 == Py_None)) {
          PyErr_SetString(PyExc_TypeError, "'NoneType' object is not iterable");
          __PYX_ERR(0, 55, __pyx_L1_error)
        }
        __pyx_t_17 = PyList_AsTuple(__pyx_t_2); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 55, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_17);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_XDECREF_SET(__pyx_v_ordered_indices, ((PyObject*)__pyx_t_17));
        __pyx_t_17 = 0;

        /* "pyknotid/cinvariants.pyx":56
 * 
 *                 ordered_indices = tuple(sorted((i1, i2, i3)))
 *                 if ordered_indices in used_sets:             # <<<<<<<<<<<<<<
 *                     continue
 * 
 */
        __pyx_t_19 = (__Pyx_PySet_ContainsTF(__pyx_v_ordered_indices, __pyx_v_used_sets, Py_EQ)); if (unlikely(__pyx_t_19 < 0)) __PYX_ERR(0, 56, __pyx_L1_error)
        __pyx_t_20 = (__pyx_t_19 != 0);
        if (__pyx_t_20) {

          /* "pyknotid/cinvariants.pyx":57
 *                 ordered_indices = tuple(sorted((i1, i2, i3)))
 *                 if ordered_indices in used_sets:
 *                     continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_19 = ((__pyx_v_a2s < __pyx_v_a1e) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_20 = __pyx_t_19;
          goto __pyx_L11_bool_binop_done;
        }
        __pyx_t_19 = ((__pyx_v_a3e < __pyx_v_a1e) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_20 = __pyx_t_19;
          goto __pyx_L11_bool_binop_done;
        }
        __pyx_t_19 = ((__pyx_v_a3e > __pyx_v_a2s) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_20 = __pyx_t_19;
          goto __pyx_L11_bool_binop_done;
 ...
 */
        __pyx_t_19 = ((__pyx_v_a3s > __pyx_v_a1e) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_20 = __pyx_t_19;
          goto __pyx_L11_bool_binop_done;
        }
        __pyx_t_19 = ((__pyx_v_a2e > __pyx_v_a3s) != 0);
        __pyx_t_20 = __pyx_t_19;
 ...
 */
          __pyx_v_representations_sum_1 = (__pyx_v_representations_sum_1 + ((__pyx_v_sign1 * __pyx_v_sign2) * __pyx_v_sign3));

          /* "pyknotid/cinvariants.pyx":62
 *                     a3s > a1e and a2e > a3s):
 *                     representations_sum_1 += sign1 * sign2 * sign3
 *                     used_sets.add(ordered_indices)             # <<<<<<<<<<<<<<
 *                 if (a2e < a1e and a3s < a1e and a3s > a2e and
 *                     a2s > a1e and a3e > a2s):
 */
          __pyx_t_18 = PySet_Add(__pyx_v_used_sets, __pyx_v_ordered_indices); if (unlikely(__pyx_t_18 == ((int)-1))) __PYX_ERR(0, 62, __pyx_L1_error)
 ...
 */
        __pyx_t_19 = ((__pyx_v_a2e < __pyx_v_a1e) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_20 = __pyx_t_19;
        ...
        __pyx_t_19 = ((__pyx_v_a3s > __pyx_v_a2e) != 0);
        if (__pyx_t_19) {
        } else {
          __pyx_t_20 = __pyx_t_19;
          goto __pyx_L17_bool_binop_done;
 ...
 * 
 */
          __pyx_v_representations_sum_2 = (__pyx_v_representations_sum_2 + ((__pyx_v_sign1 * __pyx_v_sign2) * __pyx_v_sign3));

          /* "pyknotid/cinvariants.pyx":66
 *                     a2s > a1e and a3e > a2s):
 *                     representations_sum_2 += sign1 * sign2 * sign3
 *                     used_sets.add(ordered_indices)             # <<<<<<<<<<<<<<
 * 
 * 
 */
          __pyx_t_18 = PySet_Add(__pyx_v_used_sets, __pyx_v_ordered_indices); if (unlikely(__pyx_t_18 == ((int)-1))) __PYX_ERR(0, 66, __pyx_L1_error)
 ...
 */
  ...
  __pyx_t_17 = PyFloat_FromDouble(((__pyx_v_representations_sum_1 / 2.) + __pyx_v_representations_sum_2)); if (unlikely(!__pyx_t_17)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_17);
  __pyx_r = __pyx_t_17;
  __pyx_t_17 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("pyknotid.cinvariants.vassiliev_degree_3", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_arrow1, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_arrow2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_arrow3, 1);
  __Pyx_XDECREF(__pyx_v_used_sets);
  __Pyx_XDECREF(__pyx_v_ordered_indices);
...
/* Python wrapper */
static PyObject *__pyx_pw_8pyknotid_11cinvariants_1vassiliev_degree_3(PyObject *__pyx_self, PyObject *__pyx_arg_arrows); /*proto*/
static PyObject *__pyx_pw_8pyknotid_11cinvariants_1vassiliev_degree_3(PyObject *__pyx_self, PyObject *__pyx_arg_arrows) {
  __Pyx_memviewslice __pyx_v_arrows = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("vassiliev_degree_3 (wrapper)", 0);
  assert(__pyx_arg_arrows); {
    __pyx_v_arrows = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(__pyx_arg_arrows, PyBUF_WRITABLE); if (unlikely(!__pyx_v_arrows.memview)) __PYX_ERR(0, 16, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_8pyknotid_11cinvariants_vassiliev_degree_3(__pyx_self, __pyx_v_arrows);
...
static PyObject *__pyx_pf_8pyknotid_11cinvariants_vassiliev_degree_3(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_arrows) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("vassiliev_degree_3", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_arrows.memview)) { __Pyx_RaiseUnboundLocalError("arrows"); __PYX_ERR(0, 16, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_8pyknotid_11cinvariants_vassiliev_degree_3(__pyx_v_arrows, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_arrows, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pyknotid.cinvariants.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyknotid.cinvariants.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyknotid.cinvariants.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pyknotid.cinvariants._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"vassiliev_degree_3", (PyCFunction)__pyx_pw_8pyknotid_11cinvariants_1vassiliev_degree_3, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_cinvariants(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_cinvariants},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_pyknotid_utils, __pyx_k_pyknotid_utils, sizeof(__pyx_k_pyknotid_utils), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcinvariants(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcinvariants(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_cinvariants(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_cinvariants(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_cinvariants(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'cinvariants' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_cinvariants(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("cinvariants", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pyknotid__cinvariants) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pyknotid.cinvariants")) {
      if (unlikely(PyDict_SetItemString(modules, "pyknotid.cinvariants", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_n_s_vprint);
  __Pyx_GIVEREF(__pyx_n_s_vprint);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_vprint);
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_pyknotid_utils, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_vprint); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_vprint, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pyknotid.cinvariants", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyknotid.cinvariants");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
